...
def list_entries(user_id, category=None, method=None, date_from=None, date_to=None,
    ...
    # I interpolate sort_col/order_sql directly instead of passing them as
    # query params, since column/direction names can't be bound placeholders
    # in psycopg2. I only consider this safe because both come from the fixed
    # whitelists above (SORT_COLUMNS, the asc/desc check), never raw user input.
